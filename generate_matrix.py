...
hosts = hosts | {
        "linux-gnu": hosts["linux"] | {
                ...
                "req-pkg": "python3 unzip gcc g++ git clang libclang-dev make cmake",
        ...
        "linux-musl": hosts["linux"] | {
                ...
                "req-pkg": "git bash python3 tar github-cli build-base gcc g++ clang clang-dev cmake make protobuf protobuf-dev file openssl coreutils-env",
